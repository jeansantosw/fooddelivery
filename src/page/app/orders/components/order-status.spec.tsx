...
describe('Order status', () => {
  ...
  it('should show exact text in (processing) order status', () => {
    ...
    const { getByText, getByTestId } = render(<OrderStatus status='processing' />)
  ...
  it('should show exact text in (delivering) ordeer status', () => {
    ...
    const { getByText, getByTestId } = render(<OrderStatus status='delivering' />)
  ...
  it('should show exact text in (delivered) order status', () => {
    ...
    const { getByText, getByTestId } = render(<OrderStatus status='delivered' />)
